...
@interface IMPUpdateKeyboardNumberView()
{
...
@end
@implementation IMPUpdateKeyboardNumberView
...
@end
@implementation IMPUpdateKeyboardNumberTipsView
{
...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.backgroundColor = UIColorFromRGB(0xf4f5f4);
        [self createTipsView];
    }
    return self;
}
- (void)createTipsView
{
    ...
    backView.backgroundColor = UIColorFromRGB(0xf4f5f4);
...
//{
//    tipsLabel.text = deleteStr;
//    tipsLabel.animationDuration = 0.5;
//    tipsLabel.animationDelay = 0.07;
//    [tipsLabel startDisappearAnimation];
//}
@end